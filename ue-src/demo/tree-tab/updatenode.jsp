  ...
  <body>
	...
	<form class="form-horizontal"  id="saveForm" onsubmit="return false">
		<div class="form-group">
			...
			<div class="col-xs-8 col-md-8">
				<input type="text" class="form-control ue-form Validform_input" id="name"
						name="name" value="<%=java.net.URLDecoder.decode(request.getParameter("name"),"UTF-8") %>" placeholder="名称" datatype="*1-32" errormsg="名称不要超过32个字符！" nullmsg="名称不能为空" />						
		...
		<div class="form-group">
	        ...
	        <div class="col-xs-8 col-md-8">
	           <button id="update" class="btn ue-btn-primary" >修改</button>
