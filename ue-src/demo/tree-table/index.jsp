...
<html lang="zh-CN">
  <head>
	...
	body {
		min-width: 1100px; 
		width: expression((documentElement.clientWidth > 1100) ? "1100px" : "auto" );
	}
	.form-inline {
		margin-left: 0px;
		margin-bottom: 5px;
    ...
    <div class="ue-menu-right"> 
			<form class="form-inline">										
				<div class="input-group">
			        <input class="form-control ue-form" type="text" id="organName" placeholder="请输入查询条件"/>
			    ...
			    <div class="btn-group pull-right">
					...
					<div class="btn-group">
			            ...
			            <ul class="dropdown-menu dropdown-menu-right ue-dropdown-menu">
			               <li><a id="import" href="#"><span class="fa fa-download"></span>导入</a></li>
			               <li><a id="export" href="#"><span class="fa fa-upload"></span>导出</a></li>
			               <li><a id="del" href="#"><span class="fa fa-trash"></span>删除</a></li>
			            </ul>
			         </div>
				</div>
			</form>
...
<!-- 定义表结构 -->
	<script type="text/javascript">
		...
		function renderoptions(data, type, full) {
		    return '<div class="btn-group pull-center"><button type="button" class="btn btn-xs ue-btn del" style="margin-left:5px;margin-bottom:3px" onclick="del('+data+')"><span class="fa fa-trash"></span>删除</button>'+
		    '<button  type="button"  class="btn btn-xs ue-btn modify" style="margin-bottom:3px" onclick="modify('+data+')"><span class="fa fa-cog"></span>编辑</button></div>';
		}
