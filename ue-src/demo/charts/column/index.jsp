...
$(document).ready(function(){
    var url = context + "/service/echarts/bar";
    $container = $("#bar-container1");
    $container.echarts({
        type: "bar",
        paths: "../../../dist/js",
        url: url,
	...
	<div class="ue-container">
		...
		<p>注：</p>
		<p>1.配置图表相应的DOM结构，其中，<code>.ue-bar</code>用来定义柱状图容器，<code>.ue-legend</code>是配置相应的图例，<code>.ue-echarts-content</code>用来定义柱状图图形的容器</p>
