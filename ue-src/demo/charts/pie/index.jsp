...
$(document).ready(function(){
    var url = context + "/service/echarts/pie";
    $("#pie-container1").echarts({
        type: "pie",
        paths: "../../../dist/js",
        url: url,
        xAxis: {name: "项目", value: "name"},
        yAxis: {name: "占比", value: "volume"}
    });
});
				</pre>
			</div>
	...
	<div class="ue-container">
		...
		<p>注：</p>
		<p>1.配置图表相应的DOM结构，其中，<code>.ue-pie</code>用来定义柱状图容器，<code>.ue-legend</code>是配置相应的图例，<code>.ue-echarts-content</code>用来定义柱状图图形的容器</p>
